...
./bin/yraytrace --scene tests/13_matcap/matcap.json --output out/lowres/13_matcap_720_256.jpg --samples 256 --resolution 720

./bin/yraytrace --scene tests/02_matte/matte.json --output out/lowres/14_toon_720_9.jpg --samples 9 --shader toon --resolution 720